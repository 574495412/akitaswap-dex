...
import "./SafeMath.sol";
import "./AkitaswapV2Library.sol";

// library containing some math for dealing with the liquidity shares of a pair, e.g. computing their exact value
// in terms of the underlying tokens
library AkitaswapV2LiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        (reserveA, reserveB) = AkitaswapV2Library.getReserves(
            factory,
            tokenA,
            tokenB
        );
        ...
        require(
            ...
            "AkitaswapV2ArbitrageLibrary: ZERO_PAIR_RESERVES"
        );
        ...
        if (aToB) {
            uint amountOut = AkitaswapV2Library.getAmountOut(
                amountIn,
                reserveA,
                reserveB
            );
    ...
    function getLiquidityValue(
        ...
        (uint256 reservesA, uint256 reservesB) = AkitaswapV2Library.getReserves(
            factory,
            tokenA,
            tokenB
        );
        IUniswapV2Pair pair = IUniswapV2Pair(
            AkitaswapV2Library.pairFor(factory, tokenA, tokenB)
        );
